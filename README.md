...
create-react-app なしの TS + React の雛形

## 参考 URL

- [脱 create-react-app、React アプリの小さめ構築](https://shinyaigeek.dev/post/without-create-react-app)
- [TypeScript x React アプリの雛形を自作する(webpack, babel など)](https://zenn.dev/haga/articles/2e8fe15a46e88b3437f1)
